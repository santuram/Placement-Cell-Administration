  ...
  <div id="place">
     ...
     <% Class.forName("com.mysql.jdbc.Driver"); 
       ...
       %>
              ...
              <form action = "adminShortlist.jsp" method ="POST" >
...
if(selectValue != null && selectValueTwo == null)
{
    ...
    session.setAttribute("sessionTempUniqueNumber", selectValue);
            ...
            ResultSet rs = stOne.executeQuery("select * from appliedjob where uniquenumber='"+selectValue+"' and selected='0' and shortlist='0'");
            ...
            <table width="65%">
                <tr><td><center>
                    <input class="LeftPanelButton"type="submit"></center></td></tr></table>
            </form>
...
if(selectValueTwo != null)
{
   ...
   //         out.println("dfs");
            ...
            {
               jj = st.executeUpdate("UPDATE APPLIEDJOB SET SHORTLIST = 1 WHERE emailid='"+selectValueTwo[ii].toString()+"' and uniquenumber='"+sessionTempUniqueNumber+"'");
    ...
    <div id="size">
      <ul>
        ...
        <li><a href="adminRemoveStudent.jsp">Remove Students</a></li>
         <li class="active"><a href="adminShortlist.jsp">Shortlist Students</a></li>
