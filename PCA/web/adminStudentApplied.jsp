...
<table width="65%" cellspacing ="20" cellpadding="20">
...
<%
    ...
    <li><a href="#"  id="left-menu" href="#sidr-left">Account</a></li> </ul>
  </div>
  </div>
...
<div id="sidr-left-stud" >
  ...
  <div id="sidr-left-acc" >
      ...
      <ul>
        ...
        <li><a href="commonChangePassword.jsp">Change password</a></li>
