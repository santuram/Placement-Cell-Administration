...
ResultSet rs=st.executeQuery("select * from appliedjob where companyname='"+companyName+"' AND selected='1' ");
...
<div id="sidr-left-rep" >
      ...
      <ul>
        ...
        <li class="active"><a href="companyStudentsApplied.jsp">Candidates who have Applied</a></li>
...
<%
          ...
          {
          //access denied . pl login correctly
