...
Welcome <%= sessionName %>          
  ...
  <header>
    <h2 style="font-variant: small-caps;">Change Password</h2>
       ...
       <form id="changepass" name="changePassword" action="companyChangePassword.jsp" method="post">
...
ResultSet rs=st.executeQuery("select password from recruiterdetail where emailid='"+sessionEmailid+"'"); 
if(rs.next())
{
    ...
    ResultSet rsOne; 
int i=stOne.executeUpdate("UPDATE recruiterdetail SET password='"+password+"' WHERE emailid='"+sessionEmailid+"'"); 
    %> 
...
<br> 
<center>Login with your new password</center>
<br><a href="index.jsp"><b>Go back To Home Page</b></a>
...
<br>
<br>
<center>Your OldPassword is wrong! Re-enter ur OldPassword</center>
...
Password Change Successful</div>-->
...
<div id="sidr-left-acc" >
    <div id="size">
      <ul>
         ...
         <li class="active"><a href="companyChangePassword.jsp">Change password</a></li>
